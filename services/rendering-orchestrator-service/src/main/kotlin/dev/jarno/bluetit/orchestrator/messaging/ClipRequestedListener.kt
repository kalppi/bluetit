...
class ClipRequestedListener(
    ...
    fun handleClipRequested(message: ClipRequestedMessage) {
        logger.info("Received clip request message: clipRequestId={}, episodeId={}",
            message.clipRequestId, message.episodeId)
